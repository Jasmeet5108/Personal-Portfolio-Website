...
const Home = () => {
    return (
        <>
            <div id="home" className='max-w-screen-xl mx-auto mt-[-120px] sm:mt-[60px] flex flex-col md:flex-row md:justify-between md:items-center md:px-4 lg:px-1 md:mt-7 w-full'>
                <div className="left text-3xl text-center md:text-left md:text-3xl lg:text-4xl xl:text-5xl px-[10px]">
                    ...
                    <p className='text-base lg:text-lg xl:text-xl mt-4 w-full md:w-[400px] lg:w-[600px] xl:w-[800px] md:mt-6 lg:mt-8 xl:mt-10'>I enjoy developing creative applications.
                        <br />
